...
while True:
	...
	# Contornos
	contorno_1 = cv2.findContours(cara_1, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
	contorno_1 = imutils.grab_contours(contorno_1)

	contorno_2 = cv2.findContours(cara_2, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
	contorno_2 = imutils.grab_contours(contorno_2)

	contorno_3 = cv2.findContours(cara_3, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
	contorno_3 = imutils.grab_contours(contorno_3)

	contorno_4 = cv2.findContours(cara_4, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
	...
	for c in contorno_1:
		...
		if area_1 > 5000:
			...
			cv2.putText(ventana, "Amarillo", (cx - 20, cy - 20), cv2.FONT_ITALIC, 2, (255, 255, 255), 2)
	...
	for c in contorno_2:
		...
		if area_1 > 5000:
			...
			cv2.circle(ventana, (cx, cy), 7, (255, 255, 255), -1)
			cv2.putText(ventana, "Rojo", (cx - 20, cy - 20), cv2.FONT_ITALIC, 2, (255, 255, 255), 2)
	...
	for c in contorno_3:
		...
		if area_1 > 5000:
			...
			cv2.circle(ventana, (cx, cy), 7, (255, 255, 255), -1)
			cv2.putText(ventana, "Verde", (cx - 20, cy - 20), cv2.FONT_ITALIC, 2, (255, 255, 255), 2)
	...
	for c in contorno_4:
		...
		if area_1 > 5000:
			...
			cv2.circle(ventana, (cx, cy), 7, (255, 255, 255), -1)
			cv2.putText(ventana, "Azul", (cx - 20, cy - 20), cv2.FONT_ITALIC, 2, (255, 255, 255), 2)
